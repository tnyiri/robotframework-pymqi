...
pq.purge_queue('T1.SVC1.REQUEST')
print('')

print('Test step: Put a message into a queue in queuemanager and read it back...')
imsg = 'Hello world!'
pq.put_message(imsg, 'T1.SVC1.REPLY')
msgs = pq.get_all_messages('T1.SVC1.REPLY')
print('Message got back from queue: [', msgs, '].')
print('')

print('Test step: Put 3 message into a queue and read only the 1st one of them back...')
pq.put_message('Hello world_t1_1', 'T1.SVC1.REPLY')
pq.put_message('Hello world_t1_2', 'T1.SVC1.REPLY')
pq.put_message('Hello world_t1_3', 'T1.SVC1.REPLY')
msg = pq.get_message('T1.SVC1.REPLY')
print('Message got back from queue: [', msg, '].')
pq.purge_queue('T1.SVC1.REPLY')
print('')

print('Test step: Put 3 message into a queue and read all of them back in one step...')
pq.put_message('Hello world1_t2_1', 'T1.SVC1.REPLY')
pq.put_message('Hello world1_t2_2', 'T1.SVC1..REPLY')
pq.put_message('Hello world1_t2_3', 'T1.SVC1.REPLY')
...
fih.write(ifmsg)
fih.close()
pq.put_message_from_file("schrkd_input.msg", 'T1.SVC1.REPLY')
pq.get_message_into_file('T1.SVC1.REPLY', "schrkd_output.msg")
print('Message got back from queue into file: [')
with open("schrkd_output.msg", "r+") as file1: 
    print(file1.read()) 
print('].')
...
pq.put_message_from_file("schrkd_input.msg", 'T1.SVC1.REPLY')
pq.put_message_from_file("schrkd_input.msg", 'T1.SVC1.REPLY')
pq.get_all_messages_into_file('T1.SVC1.REPLY', "schrkd_output.msg")
print('Message got back from queue into file: [')
with open("schrkd_output.msg", "r+") as file1: 
    print(file1.read()) 
print('].')
